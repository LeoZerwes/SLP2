# Spoken Language Processing 2024/2025 - Instituto Superior Técnico
...
- lab2_intro.ipynb: This introduction notebook presents the target task, the two main parts of this assignment, the data used and the Kaggle competition and final mandatory deliverables. It also demonstrates the data class used to download data and do feature extraction.
...
- lab2_ssl.ipynb: **UNDER CONSTRUCTION ** This notebook contains the code that permits training and evaluating a modern system based on self-supervised learning (SSL) models.
